...
namespace VinilSales.WebAPI.Controllers
{
    ...
    public class PedidoController : BaseController
    {
        ...
        {
            return CreateActionResponse(await _mediator.Send(new CancelarPedidoCommand(key)));
        }
        ...
        {
            return CreateActionResponse(await _mediator.Send(new FinalizarPedidoCommand(key)));
        }
        ...
        {
            return CreateActionResponse(await _mediator.Send(new ObterPedidoQuery(key)));
        }
        ...
        public async Task<IActionResult> Post([FromBody] SalvarPedidoModel model)
        {
            ...
            return CreateActionResponse(await _mediator.Send(new CriarPedidoCommand(model.IdCliente, itens)));
        }
    }
}
